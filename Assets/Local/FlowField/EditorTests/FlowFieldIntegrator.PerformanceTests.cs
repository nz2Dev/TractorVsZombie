...
public class FlowFieldIntegrator_PerformanceTests {
    ...
    [Test]
    public void IntegrateField100Size_20RandomWallsWithLOS_Under1Millis() {
        int size = 100;
        var goal = new Vector2Int(size / 2, size / 2);
        var field = new FlowField(size, null);
    ...
    [Test]
    public void IntegrateField100Size_BlockedLOS_Under1Millis() {
        int size = 100;
        var goal = new Vector2Int(0, 0);
        var field = new FlowField(size, null);
        field[0, 1] = new Cell { cost = Cell.WallCost };
        field[1, 1] = new Cell { cost = Cell.WallCost };
        field[2, 1] = new Cell { cost = Cell.WallCost };
        field[3, 1] = new Cell { cost = Cell.WallCost };
