...
public class VehicleServiceTest : IPrebuildSetup, IPostBuildCleanup {
    ...
    public IEnumerator Create4WheelsVehicle_StaysAtPosition() {
        ...
        vehicleService.CreateVehicle(position, new VehiclePhysicsData {
            mass = 100,
            baseSize = baseSize,
            wheelAxisDatas = new WheelAxisData[] {backAxis, frontAxis},
        });
    ...
    private int Create2WheelsTrailerVehicle(Vector3 position) {
        ...
        var backAxis = new WheelAxisData { drive = true, halfLength = 0.15f, forwardOffset = -0.15f, upOffset = 0f, radius = 0.1f};
        return vehicleService.CreateVehicle(position, new VehiclePhysicsData {
            mass = 100,
            baseSize = baseSize, 
            wheelAxisDatas = new WheelAxisData[] {backAxis},
        });
    }
